    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_assess', models.BooleanField(default=False, verbose_name='调度员分配')),
                ...
                ('evaluation', models.CharField(blank=True, max_length=200, verbose_name='订单评价')),
                ...
                ('division', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='snack.Division', verbose_name='单位/院系/部门')),
                ('serviceType', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='snack.ServiceType', verbose_name='服务类型')),
                ('technician', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='order', to='office.VipUser', verbose_name='维修员')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='img', to='snack.Order', verbose_name='订单')),
            ],
        ),
    ]
