    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vipUserInfo', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='snack.VipUserInfo', verbose_name='用户信息')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technician', models.CharField(default='NaN', max_length=50, verbose_name='维修员')),
                ...
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='snack.Division', verbose_name='单位/院系/部门')),
